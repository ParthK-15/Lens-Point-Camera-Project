module.exports = [
  {
    "title": "Gitzo Systematic Video Tripod",
    "slug": "gitzo-video",
    "company": "Gitzo",
    "price": 22000,
    ...
    "features": [
      "Professional-grade tripod with robust columns for video work.",
      "Strong load capacity ideal for cameras and accessories.",
      "Stable platform for tracking and panning shots.",
      "Durable construction for demanding shoot environments.",
      "Compatible with fluid heads and video rigs.",
      "Reinforced leg locks prevent twist and wobble."
    ],
    "specifications": [
      {
        "key": "Material",
    ...
    "connectivity": [
      {
        "title": "Head Compatibility",
        "description": "Pairs easily with your preferred fluid or hybrid video head."
      },
      {
        "title": "Accessory Mounts",
        "description": "Use with camera monitors, microphones and stabilizer rigs."
      },
      {
        "title": "Secure Setup",
        "description": "High-strength clamps ensure that the legs remain firmly in place."
      },
      {
        "title": "Load Distribution",
        "description": "Designed to balance heavy loads and minimize vibration."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/JvMDbzT8Nk4?si=XxIyXv3FZT8LkSPz",
    "category": "tripod",
    "subCategory": "video"
  },
  {
    "title": "Manfrotto 504HD Video Head with Tripod",
    ...
    "features": [
      "High-performance video head for smooth motion control.",
      "Supports heavy camera setups up to 12kg.",
      "Fluid base provides silky pans and tilts.",
      "Counterbalanced support for camera rig stability.",
      "Easy to adjust drag and tilt settings.",
      "Complete tripod package for professional video shoots."
    ],
    "specifications": [
      {
        "key": "Material",
    ...
    "connectivity": [
      {
        "title": "Fluid Head",
        "description": "Offers smooth camera movement for cinematic video capture."
      },
      {
        "title": "Accessory Compatibility",
        "description": "Works with camera monitors, microphones, and other video accessories."
      },
      {
        "title": "Secure Mount",
        "description": "Stable camera attachment keeps gear safe during long shoots."
      },
      {
        "title": "Balance Control",
        "description": "Fine-tune tilt and pan drag for smooth, controlled movement."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/4QZkRC0M-sM?si=2D0j1mDVE2gyCwM0",
    "category": "tripod",
    "subCategory": "video"
  },
  {
    ...
    "features": [
      "Aluminum legs with advanced locking system for secure setup.",
      "Compact folding design for easy travel and storage.",
      "Quick release plate compatible with most cameras.",
      "Maximum load capacity of 8kg for DSLR and mirrorless rigs.",
      "Rubber feet for reliable grip on uneven terrain.",
    ...
    "connectivity": [
      {
        "title": "Quick Release",
        "description": "Fast camera mounting and removal with a secure quick release plate."
      },
      {
        "title": "Accessory Compatibility",
        "description": "Compatible with many camera heads, smartphone holders, and action camera adapters."
      },
      {
        "title": "Camera Support",
        "description": "Supports DSLR and mirrorless cameras, as well as compact video rigs."
      },
      {
        "title": "Height Adjustment",
        "description": "Easy to adjust center column and leg lengths for quick setup."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/58-hN4h19dA?si=ZxT0eK0mQvFjv2Xy",
    "category": "tripod",
    "subCategory": "video"
  },
  {
    "title": "MeFOTO Global Mini Tripod",
    "slug": "mefoto-mini",
    "company": "MeFOTO",
    "price": 3500,
    ...
    "features": [
      "Miniature form factor for tabletop and desktop use.",
      "Lightweight and portable for on-the-go content creation.",
      "Supports compact cameras, smartphones, and action cameras.",
      "Smartphone adapter compatibility with quick mounting.",
      "Easy twist locks for fast deployment.",
      "Solid base for stable low-angle shots."
    ],
    "specifications": [
      {
        "key": "Material",
    ...
    "connectivity": [
      {
        ...
        "description": "Works with cameras, smartphones, and action cameras using standard mounts."
      },
      {
        "title": "Quick Setup",
        "description": "Fast twist locks and ball head adjustments make setup easy."
      },
      {
        "title": "Portable",
        "description": "Small size allows it to fit in travel cases and bags comfortably."
      },
      {
        "title": "Stable Support",
        "description": "Delivers reliable stability for low-angle and tabletop recording."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/LipLrB7wQfo?si=B7Z6Gz7zp4yK39Mv",
    "category": "tripod",
    "subCategory": "video"
  },
  {
    ...
    "features": [
      "Travel-ready design collapses to a compact length.",
      "High strength-to-weight ratio for everyday shooters.",
      "Corrosion-resistant construction for longevity.",
      "Easy to adjust leg angles and height levels.",
      "Compatible with a wide range of cameras.",
      "Quick-release plate for speedy workflow."
    ],
    "specifications": [
      {
        "key": "Material",
    ...
    "connectivity": [
      {
        "title": "Ready for Accessories",
        "description": "Attach cameras, lights, and phone mounts with the included quick release system."
      },
      {
        "title": "Secure Platform",
        "description": "Provides a strong base for mirrorless cameras and small DSLRs."
      },
      {
        "title": "Fast Setup",
        "description": "Deploys quickly so you can start shooting right away."
      },
      {
        "title": "Multipurpose Use",
        "description": "Suitable for landscapes, portraits, and on-the-go content creation."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/WQ7V2xLz6B8?si=73ji9J24C0YBmI7B",
    "category": "tripod",
    "subCategory": "travel"
  },
  {
    "title": "Sirui Traveler Portable Tripod",
    "slug": "sirui-traveler",
    "company": "Sirui",
    "price": 8500,
    ...
    "features": [
      "Carbon fiber construction keeps weight low and strength high.",
      "4-section legs fold compactly for easy storage.",
      "Integrated ball head for fast setup and framing.",
      "Maximum load capacity of 6kg for mirrorless and compact DSLR rigs.",
      "Ergonomic twist locks for quick adjustment.",
    ...
    "connectivity": [
      {
        "title": "Quick Release",
        "description": "The included quick release system speeds up camera mounting and dismounting."
      },
      {
        "title": "Accessory Ready",
        "description": "Compatible with smartphone clamps, LED lights, and most tripod heads."
      },
      {
        "title": "Portable",
        "description": "Designed to fit into backpacks and carry-on luggage with ease."
      },
      {
        "title": "Stable Base",
        "description": "Rubber feet provide a secure stance on pavement, gravel, and terrain."
      }
    ],
    "youtubeVideo": "https://www.youtube.com/embed/kD1_PnM8Gqg?si=UJ22vTFwjHYqAasw",
    "category": "tripod",
    "subCategory": "travel"
  }
];